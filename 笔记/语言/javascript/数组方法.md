...
```js
js
复制代码const arr = ["March", "Jan", "Feb", "Dec", 6, 2, "A", "a"];
...
```js
js
复制代码const arr = ["March", "Jan", 6, 2, "A", "a"];
arr.reverse();
...
```js
js
复制代码const arr1 = ["March", "Jan", 6, 2, "A", "a"];
...
```js
js
复制代码const newArr = Array.from("March");
...
```js
js
复制代码const arr = ["March", "Jan", 6, 2, "A", 6, "a"];
...
```js
js
复制代码const newArr = Array.of("March", "Jan", 6, 2, "A", "a");
console.log(newArr);//[ 'March', 'Jan', 6, 2, 'A', 'a' ]
